...
const resources = {
  en: {
    translation: {
      ...
      smartCompare: {
        groupLabel: "Group {{index}} · {{count}} images",
        similarity: "Similarity {{percent}}%",
        algoConfirmed: "{{matched}}/{{total}} algorithms",
        copied: "Copied",
        copyInfo: "Copy info",
        recomputing: "Computing…",
        recompute: "Recompute features",
        title: "Duplicate check result",
        copy: "Copy",
        totalImages: "{{count}} images",
        totalAlgorithms: "{{count}} algorithms",
        allUnique: "All unique",
        duplicateStats: "{{groups}} duplicate groups · {{unique}} unique",
        allUniqueTitle: "All images are unique",
        allUniqueDesc: "No similar pairs found across {{count}} algorithms (with 8-direction rotation)",
      },
      notfound: {
        code: "404",
  ...
  zh: {
    translation: {
      ...
      smartCompare: {
        groupLabel: "第 {{index}} 组 · {{count}} 张图片",
        similarity: "相似度 {{percent}}%",
        algoConfirmed: "{{matched}}/{{total}} 算法确认",
        copied: "已复制",
        copyInfo: "复制信息",
        recomputing: "正在计算…",
        recompute: "重新计算特征",
        ...
        totalAlgorithms: "{{count}} 种算法",
        allUnique: "全部唯一",
        duplicateStats: "{{groups}} 组疑似重复 · {{unique}} 张唯一",
        allUniqueTitle: "所有图片均为唯一",
        allUniqueDesc: "在 {{count}} 种算法（含 8 方向旋转检测）下，均未发现相似图片对",
      },
      notfound: {
        code: "404",
        title: "抱歉，页面未找到",
